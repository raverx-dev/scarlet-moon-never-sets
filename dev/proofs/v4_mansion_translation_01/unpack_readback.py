...
manifest={'project_id':'scarlet-moon-never-sets','candidate':True,'source_commit':'44530dd918ce498544025ca1919e91faccb619d4','assets':{}}
for name,v in b['assets'].items():
    ...
    manifest['assets'][name].update(revision=e['revision'],revision_hash=e['revision_hash'],render_hash=v['view']['structuredContent']['render_hash'],round_trip=e['round_trip'],approval=v['approval'].get('structuredContent'),from_revision=a.get('from_revision'))
