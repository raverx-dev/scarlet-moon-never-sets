...
Versions 1, 2, and 3 are frozen. Version 3 is the owner-approved visual-redesign snapshot. Remaining Version 3 imperfections are accepted; later corrections belong in Version 4. Version 4 has begun as an evolving, non-frozen development preview.
...
| Version 4 — Development Preview | Initial playable development build with approved RoboPixel splash logo and RAVER X DEV credits; later sprite, scene and backlog work remains | Ongoing V4 development | `versions/v4/` | In development (not frozen) |
...
Public Version 3 is frozen in place and must not be updated. Version 4 has begun separately under `versions/v4/`; its public development preview is neither the final V4 release nor frozen.
